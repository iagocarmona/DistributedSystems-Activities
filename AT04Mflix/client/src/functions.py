...
def create_movie(connection):
    ...
    movie.runtime = int(
        input("Informe a duração do filme em minutos <number>: "))
    ...
    movie.poster = input(
        "Informe o link para a URL do poster filme <string>: ")
...
def update(connection):
    ...
    founded_movie = connection.getMoviesById(
        find_movie_request)  # get movie based on id
    ...
    founded_movie.runtime = int(
        runtime) if runtime.strip() != "" else founded_movie.runtime
    ...
    num_mflix_comments = input(
        "Informe a quantidade de comentários <number>: ")
    founded_movie.num_mflix_comments = int(num_mflix_comments) if num_mflix_comments.strip(
    ) != "" else founded_movie.num_mflix_comments
...
def delete(connection):
    # get movie id
    movie_id = input("Informe o id do filme a ser deletado <string>: ")
